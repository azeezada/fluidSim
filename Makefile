...
# IDENTIFIER  = 40FB54C86566B9DDEAB902CC80E8CE85C1C62AAC
...
# CXXFLAGS = -std=c++1z -Wall -Werror -Wextra -pedantic # removed -Wconversion flag
...
shortcut:
g++ -std=c++1z -Wall -Werror -Wextra -pedantic  -O3 -DNDEBUG -c fsim.cpp -I/mnt/c/Users/dawoo/webdev/fluid/SFML-2.5.1/include
g++ fsim.o -o fsim-app -L/mnt/c/Users/dawoo/webdev/fluid/SFML-2.5.1/lib -lsfml-graphics -lsfml-window -lsfml-system
export LD_LIBRARY_PATH=/mnt/c/Users/dawoo/webdev/fluid/SFML-2.5.1/lib && ./fsim-app